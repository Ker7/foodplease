...
class InventoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        $inventory = $query->with('unit')->latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        // Set default for low_stock_threshold if null
        $validated['low_stock_threshold'] = $validated['low_stock_threshold'] ?? 0;

        $item = Inventory::create($validated);
        $item->load('unit'); // Load the unit relationship for display
    ...
    public function update(Request $request, Inventory $inventory)
    {
        ...
        $inventory->load('unit'); // Load the unit relationship for display
